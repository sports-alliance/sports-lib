...
description: Add, correct, rename, or retire a normalized sports-lib activity metric. Use for FIT, GPX, TCX, or provider-JSON field mapping; Data class, unit, display, serialization, or canonical-token changes; and metric-related public API or documentation updates.
---
...
Run the narrowest affected Jest specs, then `npm run build`. Run `npm run docs:build` whenever public API or consumer documentation changes.
