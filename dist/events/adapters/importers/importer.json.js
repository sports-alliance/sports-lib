...
var EventImporterJSON = /** @class */ (function () {
    ...
    EventImporterJSON.getFromJSONString = function (jsonString, id) {
        ...
        var _loop_1 = function (activityObject) {
            var activity = new activity_1.Activity(new Date(activityObject.startDate), new Date(activityObject.endDate));
            ...
            var _loop_2 = function (lapObject) {
                var lap = new lap_1.Lap(new Date(lapObject.startDate), new Date(lapObject.endDate));
