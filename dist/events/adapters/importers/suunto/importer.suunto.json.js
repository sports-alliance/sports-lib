...
var EventImporterSuuntoJSON = /** @class */ (function () {
    ...
    EventImporterSuuntoJSON.getFromJSONString = function (jsonString) {
        ...
        creator.name = importer_suunto_device_names_1.ImporterSuuntoDeviceNames[eventJSONObject.DeviceLog.Device.Name] || eventJSONObject.DeviceLog.Device.Name;
        ...
        var activities = activityStartEventSamples.map(function (activityStartEventSample, index) {
            ...
            activity.type = activity_types_1.ActivityTypes[importer_suunto_activity_ids_1.ImporterSuuntoActivityIds[activityStartEventSample.Events[0].Activity.ActivityType]];
        ...
        var laps = lapEventSamples.reduce(function (lapArray, lapEventSample, index) {
            ...
            // Set the start date.
            var lap = new lap_1.Lap(lapStartDatesByType[lapEventSample.Events[0].Lap.Type], lapEndDate);
            // Set it for the next run
            lapStartDatesByType[lapEventSample.Events[0].Lap.Type] = lapEndDate;
            lap.type = lap_types_1.LapTypes[lapWindows[index].Type];
        ...
        activities.forEach(function (activity) {
            laps.filter(function (lap) {
                ...
                return false;
            }).forEach(function (activityLap, index, activityLapArray) {
        ...
        activities.forEach(function (activity) {
            ...
            eventJSONObject.DeviceLog.Samples.forEach(function (sample) {
                ...
                if (point && (point.getDate() >= activity.startDate) && (point.getDate() <= activity.endDate)) {
                    ...
                    if (_this.hasFusedLocData(sample) && !activity.getStat(data_fused_location_1.DataFusedLocation.className).getValue()) {
