...
var ActivityTypesHelper = /** @class */ (function () {
    function ActivityTypesHelper() {
    }
    ActivityTypesHelper.getActivityTypesAsUniqueArray = function () {
        return Array.from(new Set(Object.keys(ActivityTypes).reduce(function (array, key) {
            array.push(ActivityTypes[key]); // Important get the key via the enum else it will be chaos
            return array;
        }, [])));
    };
    ActivityTypesHelper.averageSpeedDerivedMetricsToUseForActivityType = function (activityType) {
        switch (activityType) {
            case ActivityTypes.Running:
            case ActivityTypes['Trail Running']:
                return [data_pace_avg_1.DataPaceAvg.type, data_vertical_speed_avg_1.DataVerticalSpeedAvg.type];
    ...
    ActivityTypesHelper.speedDerivedMetricsToUseForActivityType = function (activityType) {
        switch (activityType) {
            case ActivityTypes.Running:
            case ActivityTypes['Trail Running']:
            case ActivityTypes.Treadmill:
            case ActivityTypes['Track and Field']:
            case ActivityTypes['Elliptical trainer']:
                return [data_pace_1.DataPace.type];
            case ActivityTypes.Swimming:
            case ActivityTypes['Open Water Swimming']:
            case ActivityTypes.swimming_lap_swimming:
...
exports.ActivityTypesHelper = ActivityTypesHelper;
/**
...
(function (ActivityTypes) {
    ...
    ActivityTypes["multisport"] = "Multisport";
    ActivityTypes["running_virtual_activity"] = "Running";
    ...
    ActivityTypes["downhill"] = "Downhill skiing";
