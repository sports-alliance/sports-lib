...
var DataBatteryCurrent = /** @class */ (function (_super) {
    __extends(DataBatteryCurrent, _super);
    function DataBatteryCurrent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataBatteryCurrent.prototype.getDisplayValue = function () {
        return this.getValue().toFixed(3);
    };
    DataBatteryCurrent.type = 'Battery Current';
    DataBatteryCurrent.unit = 'mA';
    return DataBatteryCurrent;
