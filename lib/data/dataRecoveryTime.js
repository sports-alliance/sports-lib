...
var DataRecoveryTime = /** @class */ (function (_super) {
    ...
    DataRecoveryTime.prototype.getDisplayValue = function (showDays, showSeconds) {
        if (showDays === void 0) { showDays = true; }
        if (showSeconds === void 0) { showSeconds = false; }
        return _super.prototype.getDisplayValue.call(this, showDays, showSeconds);
    };
