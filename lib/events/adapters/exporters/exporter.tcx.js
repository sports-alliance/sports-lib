    ...
    EventExporterTCX.prototype.getAsString = function (event) {
        ...
        var _loop_1 = function (activity) {
            ...
            if (!activityLaps.length) {
                var lap_2 = new lap_1.Lap(activity.startDate, activity.endDate, lap_types_1.LapTypes.AutoLap);
            ...
            for (var _i = 0, activityLaps_1 = activityLaps; _i < activityLaps_1.length; _i++) {
                ...
                var dataEnergy = lap.getStat(data_energy_1.DataEnergy.className);
                if (dataEnergy) {
                ...
                var _loop_2 = function (point) {
                    ...
                    point.getData().forEach(function (data) {
                        if ((data instanceof data_altitude_1.DataAltitude)) {
