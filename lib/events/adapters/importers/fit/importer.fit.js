...
var FitParser = require('fit-parser').default;
var EventImporterFIT = /** @class */ (function () {
    ...
    EventImporterFIT.getFromArrayBuffer = function (arrayBuffer, name) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            fitParser.parse(arrayBuffer, function (error, fitDataObject) {
                debugger;
    ...
    EventImporterFIT.getCreatorFromFitDataObject = function (fitDataObject) {
        ...
        switch (fitDataObject.file_id.manufacturer) {
            case 'suunto': {
                creator = new creator_1.Creator(importer_fit_suunto_device_names_1.ImporterFitSuuntoDeviceNames[fitDataObject.file_id.product] || 'Suunto Unknown');
                break;
            }
            case 'garmin': {
                creator = new creator_1.Creator(importer_fit_garmin_device_names_1.ImporterFitGarminDeviceNames[fitDataObject.file_id.product] || 'Garmin Unknown');
                break;
            }
            case 'zwift': {
                creator = new creator_1.Creator(importer_fit_swift_device_names_1.ImporterZwiftDeviceNames[fitDataObject.file_id.product] || 'Zwift Unknown');
                break;
            }
            default: {
                creator = new creator_1.Creator((fitDataObject.file_id.manufacturer || '')
