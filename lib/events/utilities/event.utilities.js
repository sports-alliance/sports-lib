...
var EventUtilities = /** @class */ (function () {
    ...
    EventUtilities.generateMissingUnitStreamsForActivity = function (activity) {
        // Generate pace from speed
        if (activity.hasStreamData(data_speed_1.DataSpeed.type) && !activity.hasStreamData(data_pace_1.DataPace.type)) {
            activity.addStream(new stream_1.Stream(data_pace_1.DataPace.type, activity.getStreamData(data_speed_1.DataSpeed.type).map(function (dataValue) {
        ...
        if (activity.hasStreamData(data_speed_1.DataSpeed.type) && !activity.hasStreamData(data_speed_1.DataSpeedKilometersPerHour.type)) {
            activity.addStream(new stream_1.Stream(data_speed_1.DataSpeedKilometersPerHour.type, activity.getStreamData(data_speed_1.DataSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
        ...
        if (activity.hasStreamData(data_speed_1.DataSpeed.type) && !activity.hasStreamData(data_speed_1.DataSpeedMilesPerHour.type)) {
            activity.addStream(new stream_1.Stream(data_speed_1.DataSpeedMilesPerHour.type, activity.getStreamData(data_speed_1.DataSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
        ...
        if (activity.hasStreamData(data_speed_1.DataSpeed.type) && !activity.hasStreamData(data_speed_1.DataSpeedFeetPerSecond.type)) {
            activity.addStream(new stream_1.Stream(data_speed_1.DataSpeedFeetPerSecond.type, activity.getStreamData(data_speed_1.DataSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
        ...
        if (activity.hasStreamData(data_pace_1.DataPace.type) && !activity.hasStreamData(data_pace_1.DataPaceMinutesPerMile.type)) {
            activity.addStream(new stream_1.Stream(data_pace_1.DataPaceMinutesPerMile.type, activity.getStreamData(data_pace_1.DataPace.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
        ...
        if (activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeed.type) && !activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeedFeetPerSecond.type)) {
            activity.addStream(new stream_1.Stream(data_vertical_speed_1.DataVerticalSpeedFeetPerSecond.type, activity.getStreamData(data_vertical_speed_1.DataVerticalSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
                return helpers_1.convertSpeedToSpeedInFeetPerSecond(dataValue);
        ...
        if (activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeed.type) && !activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeedMetersPerMinute.type)) {
            activity.addStream(new stream_1.Stream(data_vertical_speed_1.DataVerticalSpeedMetersPerMinute.type, activity.getStreamData(data_vertical_speed_1.DataVerticalSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
        ...
        if (activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeed.type) && !activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeedFeetPerMinute.type)) {
            activity.addStream(new stream_1.Stream(data_vertical_speed_1.DataVerticalSpeedFeetPerMinute.type, activity.getStreamData(data_vertical_speed_1.DataVerticalSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
        ...
        if (activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeed.type) && !activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeedMetersPerHour.type)) {
            activity.addStream(new stream_1.Stream(data_vertical_speed_1.DataVerticalSpeedMetersPerHour.type, activity.getStreamData(data_vertical_speed_1.DataVerticalSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
        ...
        if (activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeed.type) && !activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeedFeetPerHour.type)) {
            activity.addStream(new stream_1.Stream(data_vertical_speed_1.DataVerticalSpeedFeetPerHour.type, activity.getStreamData(data_vertical_speed_1.DataVerticalSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
        ...
        if (activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeed.type) && !activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeedKilometerPerHour.type)) {
            activity.addStream(new stream_1.Stream(data_vertical_speed_1.DataVerticalSpeedKilometerPerHour.type, activity.getStreamData(data_vertical_speed_1.DataVerticalSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
                return helpers_1.convertSpeedToSpeedInKilometersPerHour(dataValue);
        ...
        if (activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeed.type) && !activity.hasStreamData(data_vertical_speed_1.DataVerticalSpeedMilesPerHour.type)) {
            activity.addStream(new stream_1.Stream(data_vertical_speed_1.DataVerticalSpeedMilesPerHour.type, activity.getStreamData(data_vertical_speed_1.DataVerticalSpeed.type).map(function (dataValue) {
                if (!helpers_1.isNumber(dataValue)) {
                    return null;
                }
                return helpers_1.convertSpeedToSpeedInMilesPerHour(dataValue);
