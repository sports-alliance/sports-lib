...
var EventUtilities = /** @class */ (function () {
    ...
    EventUtilities.mergeEvents = function (events) {
        ...
        var event = new event_1.Event("Merged at " + (new Date()).toISOString(), activities[0].startDate, activities[activities.length - 1].endDate, privacy_class_interface_1.Privacy.Private, "Merged event", true);
