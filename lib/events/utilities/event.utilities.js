...
var EventUtilities = /** @class */ (function () {
    ...
    EventUtilities.generateStatsForActivityOrLap = function (event, subject) {
        ...
        if (!subject.getStat(data_ascent_1.DataAscent.className)
            && event.getPointsWithDataClass(data_altitude_1.DataAltitude.className, subject.startDate, subject.endDate).length) {
        ...
        if (!subject.getStat(data_heart_rate_max_1.DataHeartRateMax.className)
            && event.getPointsWithDataClass(data_heart_rate_1.DataHeartRate.className, subject.startDate, subject.endDate).length) {
        ...
        if (!subject.getStat(data_cadence_max_1.DataCadenceMax.className)
            && event.getPointsWithDataClass(data_cadence_1.DataCadence.className, subject.startDate, subject.endDate).length) {
        ...
        if (!subject.getStat(data_speed_max_1.DataSpeedMax.className)
            && event.getPointsWithDataClass(data_speed_1.DataSpeed.className, subject.startDate, subject.endDate).length) {
        ...
        if (!subject.getStat(data_vertical_speed_max_1.DataVerticalSpeedMax.className)
            && event.getPointsWithDataClass(data_vertical_speed_1.DataVerticalSpeed.className, subject.startDate, subject.endDate).length) {
        ...
        if (!subject.getStat(data_power_max_1.DataPowerMax.className)
            && event.getPointsWithDataClass(data_power_1.DataPower.className, subject.startDate, subject.endDate).length) {
        ...
        if (!subject.getStat(data_temperature_max_1.DataTemperatureMax.className)
            && event.getPointsWithDataClass(data_temperature_1.DataTemperature.className, subject.startDate, subject.endDate).length) {
