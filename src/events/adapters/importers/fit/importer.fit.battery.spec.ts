...
describe('EventImporterFIT Battery Stats', () => {
  ...
  it.each(['raw', 'changes'] as const)(
    'should parse suunto-bat.fit and extract battery consumption and life estimation in %s mode',
    async deviceInfoMode => {
      ...
      const options = new ActivityParsingOptions({ generateUnitStreams: false, deviceInfoMode });
