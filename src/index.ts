...
export * from './data/data.ehpe-avg';
export * from './data/data.ehpe-max';
export * from './data/data.ehpe-min';
export * from './data/data.energy';
export * from './data/data.epoc';
export * from './data/data.evpe';
export * from './data/data.evpe-avg';
export * from './data/data.evpe-max';
export * from './data/data.evpe-min';
...
export * from './data/data.ground-contact-time';
export * from './data/data.ground-contact-time-avg';
export * from './data/data.ground-contact-time-min';
export * from './data/data.ground-contact-time-max';
...
export * from './data/data.number-of-satellites';
export * from './data/data.number-of-satellites-avg';
export * from './data/data.number-of-satellites-max';
export * from './data/data.number-of-satellites-min';
export * from './data/data.satellite-5-best-snr';
export * from './data/data.satellite-5-best-snr-avg';
export * from './data/data.satellite-5-best-snr-max';
export * from './data/data.satellite-5-best-snr-min';
