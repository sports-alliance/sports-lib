...
/**
 * This works like a all matchers for normalized lap types between different naming across services
 */
...
export type LapType = (typeof LapTypes)[keyof typeof LapTypes];

export type LapTypes = LapType;
