      ...
      it('should parse running GPX file (2)', done => {
        ...
        eventInterfacePromise
          .then((event: EventInterface) => {
            ...
            expect((activity.getStat(DataDistance.type) as DataNumber).getValue()).toBeCloseTo(14170.5, 0);
      ...
      it('should parse running GPX file (5)', done => {
        ...
        eventInterfacePromise
          .then((event: EventInterface) => {
            ...
            SpecUtils.assertNearEqual((activity.getStat(DataDistance.type) as DataNumber).getValue(), 16771.3, 1, 1);
      ...
      it('should parse cycling FIT file (1)', done => {
        ...
        eventInterfacePromise
          .then((event: EventInterface) => {
            ...
            expect(activity.generateTimeStream([DataDistance.type]).getData(true).length).toEqual(
